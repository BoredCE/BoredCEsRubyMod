...
import com.boredce.ruby.Strings;
...
public class RubyItems {
	...
	public static ItemArmor.ArmorMaterial ruby_armor = EnumHelper.addArmorMaterial("ruby_armor", Strings.MOD_ID + ":ruby", 5000, new int[]{10,10,10,10}, 50);
	
	/** Main Items */
	public static Item ruby, ruby_nugget, ruby_apple, ruby_apple_ench, ruby_carrot, ruby_pearl;
